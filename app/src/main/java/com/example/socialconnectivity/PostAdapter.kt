...
class PostAdapter(options: FirestoreRecyclerOptions<Post>, val listener: PostActivity) : FirestoreRecyclerAdapter<Post, PostAdapter.PostViewHolder>(
    options
) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostViewHolder {
        val viewHolder =  PostViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.items, parent, false))
